...
public class Runner {
    /*
    Cucumber'da Runner Class'i istedigimiz testleri calistirmak ve her
    calistirilan test icin rapor hazirlamak amaciyla kullanilir
    ...
    @Runwith notasyonu framework'umuze JUnit yuklememizin sebebidir
     ...
     glue: feature dosyalari  ile bagli olan Java dosyalarinin
           yerini gosterir Burada da tek tek class'lari degil
      ...
      tags :  @wip  calistirilacak Feature veya Scenerio(lari) isaretlemek
            icin kullanilir. Cucumber Runner class'i calistirildiginda tum
            feature dosyalarini gozden gecirir ve Runner class'inda
            belirtilen tag'a sahip TUM Feature ve Scenario(lari) calistirir

            Eger birden fazla tag'i kontrol ederek calistirmasini istersek
                    "@regression and @smoke"   ikisi calisacak demek
                    "@regression or @smoke"    ikisinden biri calissa yeter demek
       ...
       dryRun : Bir feature dosyasini ilk defa yazdigimizda
                ...
                calistirmayi denedigi ilk sari satir ve geriye kalan
                sari satirlarin eksik steplerini bize yazdirir

                Amacimiz Feature dosyasini calistirmak degil, sadece
                eksik step'lere ait kodlari olusturmak ise Runner class'inda
                dryRun=true yapip Runner class'ini calistiririz.

                dryRun =true dedigimizde Cucumber testleri calistirmaz,
                sadece eksik adim var mi diye kontrol eder, eksik adim yoksa
                Test PASSED yazar.
